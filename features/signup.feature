Feature: Sign Up
    There should be a way for users create an account with gitplaylist. It should allow for both traditional email and password sign up and allow Github single sign on account.
